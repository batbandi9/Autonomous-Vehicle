"""
Example: Multi-agent parking training.

This script demonstrates training multiple agents to park cooperatively.
"""
...
def main():
    """Train multi-agent parking."""
    print("=" * 60)
    print("Multi-Agent Parking Example")
    print("=" * 60)
    
    # Create multi-agent environment
    print("\n[1/3] Creating multi-agent parking environment...")
    n_agents = 2
    env = MultiParkingEnv(n_agents=n_agents)
